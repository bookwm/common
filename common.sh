...
src-git danshui1 https://github.com/bootli/openwrt-package.git;${SOURCE}
EOF
...
if [[ `find "${App_path}" -type d -name "zh_Hans" |grep -c "zh_Hans"` -gt '20' ]]; then
  echo "src-git danshui2 https://github.com/bootli/openwrt-package.git;Theme2" >> "feeds.conf.default"
else
  echo "src-git danshui2 https://github.com/bootli/openwrt-package.git;Theme1" >> "feeds.conf.default"
fi
